...
const config = {
  ...
  NOT_ALLOW: process.env.NOT_ALLOW !== inboxing ? process.env.NOT_ALLOW === 'true' : true,
  MODE: process.env.MODE || 'private',
  PREFIX: process.env.PREFIX || '.',
  PORT: process.env.PORT || "5000", /* Where App Will Listen On */
  OWNER_NAME: process.env.OWNER_NAME || "VDJ JOHNS",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254768390412",
